...
> -->
<footer
class="py-20 sm:py-32 bg-white dark:bg-black border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center"
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p class="">kamranlatif98@gmail.com</p>





        <!-- <p><b class="pr-2">Email</b> kamranlatif98@gmail</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href=" " target="_blank" class="text-violet-400"
                >kamranlatifch<sup class=""
