...
>
    <div
        class="bg-white dark:bg-slate-950 grid place-items-center px-4 text-5xl md:text-6xl -mt-10 sm:-mt-12 md:-mt-14 lg:-mt-16 mx-auto duration-200 text-black dark:text-white"
    >
        <i class={step.icon} />
    </div>
...
>
    <div
        class="bg-white dark:bg-slate-950 grid place-items-center h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 rounded-full mx-auto duration-200 text-black dark:text-white"
    >
        <img src={step.images[0]} alt="{step.title}" class="h-12 w-12 md:h-16 md:w-16 object-contain" />
    </div>
    <h3 class="font-medium text-xl sm:text-2xl md:text-3xl">
        {step.title}
    </h3>
